...
;(function($, window, document, undefined){
	...
	OnePageNav.prototype = {
		...
		scrollTo: function(target, callback) {
			...
			var topbar		= jQuery('.ryker_tm_topbar').outerHeight();
			
			if(jQuery('.ryker_tm_topbar').length){
				$('html, body').animate({
...
function initMap() {
    ...
    var map = new google.maps.Map(document.getElementById('ieatmaps'), {
      center: {lat: 6.4974, lng: 124.8472},
      zoom: 12,
      styles: [
    {
        "featureType": "all",
    ...
    var marker = new google.maps.Marker({
        position: new google.maps.LatLng(6.4974, 124.8472)
        , title: 'ASL'
        , map : map
